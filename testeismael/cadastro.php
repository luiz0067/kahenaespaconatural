	...
	if(file_exists("usuarios/$id.txt")){                         //Se o usuario ja existir não cadastra
		...
		if($id==""){
			...
			if(isset($recebemensagem2)){
				...
				\$cad=\"$cad\";
				?>";
				$abreid= fopen("usuarios/".$id." _2.txt","w");  //cadastrando o usuario
				fwrite($abreid,"$salvar");
				fclose($abreid);
			}
			$let="
...
<div id="tudo">
  <div id="topo">
    <div class="conteudo">
      <div id="menuItem">
      	<img src="imagens/slogam_toledo.jpg" width="359" height="137" border="0" style="float:right; margin-right:50px;"/>
      </div>
    </div>
    <div class="clear"></div>
    <div class="conteudo" id="efeito_menu">
      <div id="slogam"> </div>
    </div>
    <div id="barra" >
      <div style="width:1099px; margin-left:auto; margin-right:auto;"><img src="./imagens/slogam.png"  style="float:left; position:absolute;  margin-left:0px; margin-top:-150px;"></div>
      <div id="imagem_barra">
        <div style="width:1099px; height:260px;"><img src="./imagens/topo.jpg" height="260" width="1099"  style="float:left;  margin-left:0px;"></div>
      </div>
    </div>
  </div>
  ...
  <div class="contentprincipal">
    <div class="titulocontato">
      <div style="font-family:arial; float:left; font-size:16px; margin-left:10px; margin-bottom:50px; color:#5F0508;">PARTICIPE PREENCHENDO ABAIXO</div>
      <div style="font-family:arial; float:left; font-size:16px; margin-left:300px; margin-bottom:50px;  color:#5F0508;">LEIA O REGULAMENTO</div>
    </div>
      ...
      <div id="formulario">
        <form id="form" name="form" method="post">
          <table width="400" border="0" align="center" cellpadding="0" cellspacing="2">
            <tr>
              <td height="100" colspan="2" align="center" ><strong>Cadastre-se em nosso site </strong></td>
            </tr>
            <tr>
		...
		?></td>
            ...
            <tr>
              ...
              <td id="Qtd1" style="margin-left:100px; font-size:8px;">150</td>
            </tr>
            <tr> </tr>
            <tr>
              ...
              <td id="Qtd2" style="margin-left:100px;font-size:8px;">150</td>
            </tr>
            <tr>
              <td colspan="2" align="right" bgcolor="#FFFFFF"><a style="font-size:10px;"> 
			  <?php echo contarArquivos("usuarios/")?> </a> <a style="font-size:10px;">mensagem cadastradas</a>
                <input name="cadatrar" type="submit" id="cadatrar"  name="enviar" value="Aceito" id="enviar" value="Cadatrar" /></td>
            </tr>
          </table>
        </form>
      </div>
      <!-- inicio do regulamento -->
      <div id="formulario" style=" margin-left:70px; float:left; overflow:scroll;"> REGULAMENTO<br>
        <br>
  ...
  <div class="clear" ></div>
  <div id="rodape">
    <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="135" height="99" id="FlashID" title="flashrodape">
